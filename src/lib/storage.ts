...
import type { User, Withdrawal, Task, PaymentMethod, PointTransaction, Notification, UserTaskCompletion, SiteContent } from './types';
...
const defaultSiteContent: SiteContent = {
  contactEmail: 'support@spark.point',
  contactPhone: '+1 (234) 567-890',
  contactAddress: '123 Spark Street, Reward City, 45678',
  privacyPolicy: `## Introduction
Welcome to SparkPoint Rewards Hub. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us.
...
export const updateSiteContent = async (data: Partial<SiteContent>): Promise<void> => {
    const docRef = doc(db, "siteContent", "main");
